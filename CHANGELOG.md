...
- Upgraded `JSROOT` to `v7.11.0`. The relevant changes of this update can be seen here:
  - [`v7.10.3` changes](https://github.com/root-project/jsroot/releases/tag/7.10.3).
  - [`v7.11.0` changes](https://github.com/root-project/jsroot/releases/tag/7.11.0).

## [1.6.1] - 2026-02-18

### Changed

- Upgraded `JSROOT` to `v7.10.2`. The relevant changes of this update can be seen here:
  - [`v7.10.1` changes](https://github.com/root-project/jsroot/releases/tag/7.10.1).
  - [`v7.10.2` changes](https://github.com/root-project/jsroot/releases/tag/7.10.2).
...
- Upgraded `JSROOT` to `v7.9.0`. The relevant changes of this update can be seen here: [`v7.9.0` changes](https://github.com/root-project/jsroot/releases/tag/7.9.0).

## [1.4.2] - 2025-03-27

### Changed

- Upgraded `JSROOT` to `v7.8.2`. The relevant changes of this update can be seen here: [`v7.8.2` changes](https://github.com/root-project/jsroot/releases/tag/7.8.2).

## [1.4.1] - 2025-03-19

### Changed

- Upgraded `JSROOT` to `v7.8.1`. The relevant changes of this update can be seen here: [`v7.8.1` changes](https://github.com/root-project/jsroot/releases/tag/7.8.1).

## [1.4.0] - 2024-11-12

### Changed

- Upgraded `JSROOT` to `v7.8.0`. The relevant changes of this update can be seen here:
  - [`v7.7.5` changes](https://github.com/root-project/jsroot/releases/tag/7.7.5).
  - [`v7.8.0` changes](https://github.com/root-project/jsroot/releases/tag/7.8.0).

## [1.3.4] - 2024-10-01

### Changed

- Upgraded `JSROOT` to `v7.7.4`. The relevant changes of this update can be seen here: [`v7.7.4` changes](https://github.com/root-project/jsroot/releases/tag/7.7.4).
